...
namespace SellIt.Infrastructure.Migrations
{
    ...
    [Migration("20230103152252_sqqqwssdssdssdsdssds")]
    partial class sqqqwssdssdssdsdssds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SellIt.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.Property<int>("ProductAdressId")
                        .HasColumnType("int");

                    b.Property<string>("ProductAdressId1")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SellIt.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.HasOne("SellIt.Infrastructure.Data.Models.Adress", "ProductAdress")
                        .WithMany("Products")
                        .HasForeignKey("ProductAdressId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
