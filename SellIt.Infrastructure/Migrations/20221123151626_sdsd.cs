...
namespace SellIt.Infrastructure.Migrations
{
    ...
    public partial class sdsd : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductMessages_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ReplyProductMessages",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductMessagesId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReplyProductMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReplyProductMessages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReplyProductMessages_ProductMessages_ProductMessagesId",
                        column: x => x.ProductMessagesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReplyProductMessages_ProductId",
                table: "ReplyProductMessages",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ReplyProductMessages_ProductMessagesId",
                table: "ReplyProductMessages",
                column: "ProductMessagesId");

            migrationBuilder.CreateIndex(
                name: "IX_ReplyProductMessages_UserId",
                table: "ReplyProductMessages",
                column: "UserId");
